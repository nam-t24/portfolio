      ...
      <>
        <div className="min-h-screen bg-[#D6DBDC] relative overflow-hidden">
          ...
          <div className=" md:w-11/12 w-full mx-auto my-8 text-white relative z-10 px-4">
            <h1 className="text-3xl font-medium text-neutral-900 border-b-2 w-[15rem] border-neutral-900 mb-4">
              2023
            </h1>
            <section className="flex flex-wrap">
              <ExtraProjectCard
                title="Minted"
                description="Full-stack application aimed to bridge the gap between non-profits and donors. Allows donors to create donation applications and non-profits to apply for donations."
                link="https://github.com/nam-t24/Senior-CS-Project"
              />
              <ExtraProjectCard
                title="HackUTD X Website"
                description="Event website for the 10th iteration of HackUTD, utilizing parts of HackPortal. Reached 2000+ applicants."
                link="https://github.com/acmutd/hackutd-x-site"
              />
            </section>
            <h1 className="text-3xl font-medium text-neutral-900 border-b-2 w-[15rem] border-neutral-900 my-4 md:mt-12">
              2022
            </h1>
            <section className="flex flex-wrap">
              <ExtraProjectCard
          ...
          <div className="text-neutral-900  w-full relative z-10">
            <div className=" border-t-[1px] border-neutral-900 mx-auto text-center p-2 lg:w-1/2 w-3/4">
              © 2022 Nam Truong
            </div>
          </div>
        </div>
