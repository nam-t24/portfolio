const Experience = () => {
    return (
        <div className="bg-[#E8E3FD] text-black py-12 2xl:px-56 xl:px-44 lg:px-32 md:px-16 px-6 overflow-hidden relative">
            <h1 className="text-7xl font-semibold md:my-12 my-8 relative z-10">Experience</h1>
            {/* State Farm */}
            <section className="lg:w-11/12 w-full text-gray-700 md:text-xl text-lg relative z-10">
                ...
                <ul className='list-disc list-outside font-light mb-8'>
                    <li>
